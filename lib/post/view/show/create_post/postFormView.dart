  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          viewModel.postCreate.value.id != 0 ? "Update Post" : "Create Post",
          style: TextStyle(color: Colors.white),
        ),
        actions: [
          TextButton(
            onPressed: () {
              viewModel.onCreateOrUpdatePost(viewModel.postCreate.value.id ??
                  0); // Call create post method
              // Get.offAllNamed(RouteName.postManagePath);
            },
            child: Text(
              viewModel.postCreate.value.id != 0 ? "Update" : "Create",
              style: TextStyle(color: Colors.white),
            ),
          ),
          // TextButton(
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          //     "${ApiUrl.imageViewPath}1731171549276.jpeg",
                          //   ),
                          // ),
                          SizedBox(width: 10),
                          Expanded(
                      ...
                      child: Stack(
                        children: [
                          ...
                          if (_selectedImage != null ||
                              (viewModel.postCreate.value.id != 0 &&
                                  viewModel.postCreate.value.image != null))
                            Positioned(
                              top: 8,
                              right: 8,
                              child: GestureDetector(
